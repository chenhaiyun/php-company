<div class="acy-ad-menu">
    <ul>
        ...
        <li class="sub-menu"><a href="<?php echo site_url('admin/category/list_category') ?>">新闻分类</a></li>
        <li class="sub-menu"><a href="<?php echo site_url('admin/product/list_product') ?>">新闻管理</a></li>
    </ul>
</div>